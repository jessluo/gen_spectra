...
# a couple parameters to make consistent with marbl+cocco
ss$is_carbon_limited <- F
ss$kCO2 <- 0 
...
ss$temp_func_form_opt <- "arrhenius"
...
## override
#ss$Qp_fixed <- 1/117.0 # Anderson and Sarmiento 1994
...
"silicifier", "is_carbon_limited", "kCO2", "kFe", "kPO4", "kDOP", "kNO3", "kNH4", "kSiO3", 
...
numeric_vars <- c("kCO2", "kFe", "kPO4", "kDOP", "kNO3", "kNH4", "kSiO3", "gQfe_0", 
...
sz$temp_func_form_opt = "arrhenius"
sz$Ea <- zoo_Ea
